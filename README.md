...
## [`Посмотреть регистрации на игру`](#Посмотреть-регистрации-на-игру) ✅
...
## Посмотреть регистрации на игру
(для выполнения запроса нужно залогиниться)

**Путь:** `Get /registrations`
...
- `200` Успешно найдены регистрации на игру
```json lines
{
  // registrations - массив регистраций
  "registrations": [
    {
      // gameID - id игры на которую нужно зарегаться
      "game_id": 1,
      ...
      // registration_number - номер команды, под которым они зарегались
      "registration_number": 13,
      // created_at - время когда команда зарегестрировалась
      "created_at": "2022-12-10T13:49:51.141Z"
    },
    {
      // gameID - id игры на которую нужно зарегаться
      "game_id": 1,
